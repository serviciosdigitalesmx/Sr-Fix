  ...
  return jsonResponse({
    archivo: paginada.data.map(function(item) {
      return {
        ...
        SEGUIMIENTO_CLIENTE: item.SEGUIMIENTO_CLIENTE,
        CASO_RESOLUCION_TECNICA: item.CASO_RESOLUCION_TECNICA,
        COTIZACION_JSON: item.COTIZACION_JSON,
        FOTO_RECEPCION: item.FOTO_RECEPCION,
        CHECK_CARGADOR: item.CHECK_CARGADOR,
        CHECK_PANTALLA: item.CHECK_PANTALLA,
        CHECK_PRENDE: item.CHECK_PRENDE,
        CHECK_RESPALDO: item.CHECK_RESPALDO,
        FOLIO_COTIZACION_MANUAL: item.FOLIO_COTIZACION_MANUAL
      };
    }),
    total: paginada.total,
    page: paginada.page,
