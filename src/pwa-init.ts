((): void => {
  ...
  function ensureMeta(name: string, content: string, attr: 'name' | 'property' = 'name'): void {
  ...
  function ensureOfflineBanner(): HTMLDivElement {
    let banner = document.getElementById('pwa-offline-banner') as HTMLDivElement | null;
    if (!banner) {
  ...
  function resetClientCacheIfNeeded(): void {
